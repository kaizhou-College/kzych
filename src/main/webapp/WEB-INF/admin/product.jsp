...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-body" id="main">
			...
			<div style="padding: 15px;">
				...
				<blockquote class="layui-elem-quote">
					油菜花网络平台致力于解决学生择校难但学校招生难、学生就业难但企业招人难、学校人才培养与企业用人需求不匹配的矛盾。 <br>
					<br>要解决这些矛盾，需要您的共同参与。
				</blockquote>

				<div class="layui-row" style="margin-top: 40px;">
					<div class="layui-col-xs6 layui-col-sm6 layui-col-md4"
						style="padding: 16px 50px; box-sizing: border-box; background: #6fa028; color: #FFF;">
						<div style="width: 100%; text-align: center; margin: 20px 0;">
							<img src="${basePath}admin/images/zhaosheng.png"
								style="width: 64px;"></img>
						</div>
						...
						<div
							class="service-status zhaosheng_service_status${currentUser.uuid}"
							style="" zhaosheng_service_status${currentUser.uuid}="0">
							<button class="layui-btn open-zhaosheng-service"
								style="width: 120px;">开通</button>
						</div>
						<div
							class="service-status zhaosheng_service_status${currentUser.uuid}"
							style="display: none;"
							zhaosheng_service_status${currentUser.uuid}="1">等待审核中...</div>
						<div
							class="service-status zhaosheng_service_status${currentUser.uuid}"
							style="display: none;"
							zhaosheng_service_status${currentUser.uuid}="2">已开通</div>
						<div
							class="service-status zhaosheng_service_status${currentUser.uuid}"
							style="display: none;"
							zhaosheng_service_status${currentUser.uuid}="3">
							审核未通过
							<button class="layui-btn open-zhaosheng-service"
								style="width: 120px;">查看原因&gt;&gt;</button>
						</div>
					</div>

					<div class="layui-col-xs6 layui-col-sm6 layui-col-md4"
						style="padding: 16px 50px; box-sizing: border-box; background: #3e8624; color: #FFF;">
						<div style="width: 100%; text-align: center; margin: 20px 0;">
							<img src="${basePath}admin/images/zhaopin.png"
								style="width: 64px;"></img>
						</div>
						<div class="" style="height: 200px; text-align: center;">
						...
						<div
							class="service-status recruit_service_status${currentUser.uuid}"
							style="" recruit_service_status${currentUser.uuid}="0">
							<button class="layui-btn open-recruit-service"
								style="width: 120px;">开通</button>
						</div>
						<div
							class="service-status recruit_service_status${currentUser.uuid}"
							style="display: none;"
							recruit_service_status${currentUser.uuid}="1">等待审核中...</div>
						<div
							class="service-status recruit_service_status${currentUser.uuid}"
							style="display: none;"
							recruit_service_status${currentUser.uuid}="2">已开通</div>
						<div
							class="service-status recruit_service_status${currentUser.uuid}"
							style="display: none;"
							recruit_service_status${currentUser.uuid}="3">
							审核未通过
							<button class="layui-btn open-recruit-service"
								style="width: 120px;">查看原因&gt;&gt;</button>
						</div>
					...
					<div class="layui-col-xs6 layui-col-sm6 layui-col-md4"
						style="padding: 16px 50px; box-sizing: border-box; background: #206b0a; color: #FFF;">
						<div style="width: 100%; text-align: center; margin: 20px 0;">
							<img src="${basePath}admin/images/youcaihua.png"
								style="width: 64px;"></img>
						</div>
						<div class="" style="height: 200px; text-align: center;">
						...
						<div class="service-status ycy_service_status${currentUser.uuid}"
							style="" ycy_service_status${currentUser.uuid}="0">
							<button class="layui-btn open-ycy-service" style="width: 120px;">开通</button>
						</div>
						<div class="service-status ycy_service_status${currentUser.uuid}"
							style="display: none;" ycy_service_status${currentUser.uuid}="1">等待审核中...</div>
						<div class="service-status ycy_service_status${currentUser.uuid}"
							style="display: none;" ycy_service_status${currentUser.uuid}="2">已开通</div>
						<div class="service-status ycy_service_status${currentUser.uuid}"
							style="display: none;" ycy_service_status${currentUser.uuid}="3">
							审核未通过
							<button class="layui-btn open-ycy-service" style="width: 120px;">查看原因&gt;&gt;</button>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="layui-body" style="display: none;" id="school_auth">
			...
			<div
				style="margin-bottom: 15px; background: #eee; height: 50px; line-height: 50px;">
				<i class="layui-icon back"
			...
			<div style="padding: 0 15px 15px 15px;">
				<blockquote class="layui-elem-quote error-cause"
				...
				<div class="layui-form">
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input id="name_p" type="text" name="" placeholder="请输入学校名称"
								autocomplete="off" class="layui-input"> <input id="id_p"
								type="hidden" name="">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<select id="universityNature_p" name="interest"
									lay-filter="aihao">
									<option value="0"></option>
					...
					<div class="layui-form-item">
						...
						<form class="layui-form" method="get">
							...
							<div class="layui-input-inline">
								<input name="addrdetail" placeholder="详细地址" autocomplete="off"
									class="layui-input" type="text" id="addrdetail">
							</div>
						</form>
					</div>
							...
							<div class="layui-input-block">
								...
								<div id="container" class="layui-upload">
									...
									<div class="layui-upload-list">
										<img class="layui-upload-img" id="start-img-view2"
											style="height: 100px;">
										<p id="errText2"></p>
									</div>
						...
						<div class="layui-inline">
							...
							<div class="layui-input-block">
								...
								<div id="container" class="layui-upload">
									...
									<button name="postFiles" class='layui-btn'>开始上传</button>
									<div class="layui-upload-list">
										<img class="layui-upload-img" id="start-img-view3"
											style="height: 100px;">
										<p id="errText3"></p>
									</div>
									<input type="hidden" name="schoolLicense" id="schoolLicense"
										value="">
								</div>
							</div>
						</div>
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input id="legalPersonName_p" type="text" name=""
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input id="legalPersonCard_p" type="text" name=""
									placeholder="请输入法人身份证" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-inline">
							<!--只有选择学校类型才显示-->
							...
							<div class="layui-input-inline">
								<input id="legalPersonPhone_p" type="text" name=""
									placeholder="请输入法人电话" autocomplete="off" class="layui-input">
							</div>
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<textarea id="detail" placeholder="请输入机构简历"></textarea>
						</div>
					</div>
					...
					<div class="layui-form-item" style="text-align: center;">
						<button id="school-auth-ok" class="layui-btn" lay-submit=""
							lay-filter="demo2">申请开通</button>
	...
	<script type="text/javascript"
		src="${basePath}admin/js/uploader.min.js"></script>
	<script type="text/javascript" src="${basePath}admin/js/simditor.js"></script>
	<script type="text/javascript"
		src="${basePath}oss/lib/plupload-2.1.2/js/plupload.full.min.js"></script>
...
function init_page($) {
	...
	if (userId.trim().length > 0) {  
		$("#addrdetail").val("${User_list.address.addrdetail}");
		...
		$("#school-auth-ok").on("click",function() {
			...
			if (isNotPass == 14) {
				$.ajax({
					...
					data : {
						"university.id" : $("#id_p").val(),
						"university.name" : $("#name_p").val(), 
						"university.universityType" : $("#universityType_p").val(),
						"university.universityNature" : $("#universityNature_p").val(),
						"university.categoryid" : $("#categoryid_p").val(),
						"university.legalPersonName" : $("#legalPersonName_p").val(),
						"university.legalPersonCard" : $("#legalPersonCard_p").val(),
						"university.legalPersonPhone" : $("#legalPersonPhone_p").val(),
						"university.introduction" : $("#detail").val(),
						"university.profile" : $("#profile").val(),
						"university.schoolLicense" : $("#schoolLicense").val(),
						"university.publishStatus" : 1,
						"address.id"               :"${User_list.address.id}",
						"address.provice"    	   :$("#provid").val(),
						"address.city"             :$("#cityid").val(),
						"address.county"           :$("#areaid").val(),
						"address.addrdetail"       :$("#addrdetail").val()
					},
		...
		$("#school-auth-ok").on("click",function() {
			...
			if (isNotPass == 14) {
				$.ajax({
					...
					data : {
						"name"             :$("#name_p").val(),
						"universityType"   :$("#universityType_p").val(),
						"universityNature" :$("#universityNature_p").val(),
						"categoryid"       :$("#categoryid_p").val(),
						"legalPersonName"  :$("#legalPersonName_p").val(),
						"legalPersonCard"  :$("#legalPersonCard_p").val(),
						"legalPersonPhone" :$("#legalPersonPhone_p").val(),
						"introduction"     :$("#detail").val(),
						"userId"           :uuid,
						"profile"          :$("#profile").val(),
	...
	function isNotNull() {
		...
		if ($("#legalPersonName_p").val().trim().length > 0) {
			isNotPass = isNotPass + 1
		} else {
			shotMsg("亲请输入法人姓名");
			return false;
		...
		if (isIDCard2.test($("#legalPersonCard_p").val())
				|| isIDCard1.test($("#default_1"))) {
			isNotPass = isNotPass + 1;
		} else {
			shotMsg("亲请输入正确的身份证号");
			return false;
	...
	//招骋
	if (typeof (recruit_service_status) == 'undefined'
			|| recruit_service_status == null) {
